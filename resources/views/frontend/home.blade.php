...
>
    ...
    <div aria-hidden="true" class="absolute inset-0 -z-10">
        <div class="absolute left-1/2 top-1/4 -translate-x-1/2 -translate-y-1/2 
                    ...
                    opacity-30 rounded-full blur-3xl animate-blob"></div>
        ...
        <div class="absolute right-1/4 top-1/3 
                    ...
                    opacity-30 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
    </div>

    {{-- Content --}}
    <div class="relative z-10 px-6 text-center sm:px-8 lg:px-12">
        <h1 class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 
           ...
           bg-clip-text text-transparent animate-fadeInUp leading-tight drop-shadow-[0_2px_10px_rgba(255,255,255,0.4)]">
            ...
            <span class="block mt-2 text-gray-900 dark:text-gray-100 
                        text-lg sm:text-2xl md:text-3xl font-semibold drop-shadow-[0_1px_8px_rgba(0,0,0,0.3)]" 
                x-text="slides[active].subtitle"></span>
        </h1>

        <p class="mt-6 max-w-2xl mx-auto text-base sm:text-lg lg:text-xl 
                  text-gray-700 dark:text-gray-300 animate-fadeInUp delay-200">
            Pilih jadwal, pilih paket, bayar, dan datang! Nikmati kemudahan reservasi studio dengan sistem online yang praktis, modern, dan cepat.
        </p>
    ...
    <div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex space-x-3 z-20">
        <template x-for="(slide, i) in slides" :key="i">
            <button 
                @click="active = i"
                :class="active === i ? 'bg-white w-6' : 'bg-white/40 w-3'"
...
<div class="relative text-center mb-8 overflow-visible py-6">
  <!-- Aura Cahaya -->
  <div class="absolute inset-0 -z-10 bg-gradient-radial from-blue-400/10 via-cyan-300/5 to-transparent blur-3xl animate-pulse-slow"></div>
  ...
  <div class="text-center mb-2 overflow-visible relative px-2">
    ...
    <!-- Garis -->
    <div
      class="mt-3 w-24 sm:w-32 md:w-44 h-[3px] mx-auto rounded-full 
             bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-600 
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide scroll-fade">
          <a href="#ultra-wide"
            ...
            <h3 class="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">Ultra Wide Box</h3>
            <p class="text-gray-600 dark:text-gray-300">Layanan foto dengan efek lensa wide, maksimal 8 orang, cetakan square & 4R.</p>
          </a>
        </div>
        ...
        <div class="swiper-slide scroll-fade">
          <a href="#wide-box"
            class="card-service">
            <div class="text-indigo-600 text-5xl mb-4">🎁</div>
            <h3 class="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">Wide Box</h3>
            <p class="text-gray-600 dark:text-gray-300">Photobox fullbody dengan lensa wide, maksimal 8 orang, cetakan 4R.</p>
          </a>
        </div>
        ...
        <div class="swiper-slide scroll-fade">
          <a href="#self-photo"
            class="card-service">
            <div class="text-indigo-600 text-5xl mb-4">✨</div>
            <h3 class="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">Self Photo Studio</h3>
            <p class="text-gray-600 dark:text-gray-300">Studio mandiri dengan pencahayaan profesional untuk hasil terbaik.</p>
          </a>
        </div>
        ...
        <div class="swiper-slide scroll-fade">
          <a href="#exclusive"
            class="card-service">
            <div class="text-indigo-600 text-5xl mb-4">💎</div>
            <h3 class="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">Exclusive Box</h3>
            <p class="text-gray-600 dark:text-gray-300">Pengalaman foto eksklusif dengan latar premium dan pencahayaan sinematik.</p>
          </a>
        </div>
      </div>
...
<style>
  ...
  #features::before {
    ...
    opacity: 10; /* cukup lembut agar terlihat di light & dark mode */
    pointer-events: none;
    z-index: 0;
  }
  ...
  #features h2.scroll-fade { transition-delay: 0.1s; }
  #features .swiper-slide.scroll-fade:nth-child(1) { transition-delay: 0.15s; }
  #features .swiper-slide.scroll-fade:nth-child(2) { transition-delay: 0.25s; }
  #features .swiper-slide.scroll-fade:nth-child(3) { transition-delay: 0.35s; }
  #features .swiper-slide.scroll-fade:nth-child(4) { transition-delay: 0.45s; }
</style>
...
{{-- Cabang Kami --}}
<section class="relative py-20 bg-gradient-to-b from-white via-sky-100 to-blue-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-900 dark:text-white overflow-hidden">
  {{-- Background Pattern --}}
...
<div class="relative text-center mb-8 overflow-visible py-6">
  ...
  {{-- Floating Shapes --}}
  <div aria-hidden="true" class="absolute top-0 left-0 w-72 h-72 bg-sky-300 opacity-30 rounded-full blur-3xl animate-blob"></div>
  <div aria-hidden="true" class="absolute bottom-0 right-0 w-72 h-72 bg-blue-400 opacity-30 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
</section>
