...
<div class="container py-5">
    <div class="text-center mb-5">
        ...
        <!-- Garis -->
    <div
      class="mt-0 w-24 sm:w-32 md:w-44 h-[3px] mx-auto rounded-full 
             bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-600 
    ...
    @if ($transaction->photoResults->count())
                ...
                <div class="col-6 col-md-4 col-lg-3 fade-card">
                    <div class="photo-card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                        ...
                        <div class="card-body text-center p-2">
                            <a href="{{ $downloadUrl }}"
                            class="btn btn-download no-loader w-100 rounded-pill"
        ...
        <div class="text-center mt-5">
            ...
            class="btn btn-download-all rounded-pill px-4 py-2 no-loader"
            download>
...
.photo-wrapper img:hover { transform: scale(1.04); }
...
/* 🌙 Dark mode */
.dark .photo-card { background: #1e1e1e; box-shadow: 0 6px 15px rgba(255,255,255,0.06); }
.dark .photo-wrapper { background: #2a2a2a; }
.dark .btn-download { color: #ddd; border-color: #555; }
.dark .btn-download:hover { background: #333; }
...
@keyframes swipeMove {
    ...
    25%  { transform: translateX(6px); opacity: 0.8; }
    50%  { transform: translateX(0); opacity: 1; }
    75%  { transform: translateX(-6px); opacity: 0.8; }
    100% { transform: translateX(0); opacity: 1; }
}

/* Tombol Download & Share (versi kotak) */
.gl-extra-buttons {
    position: fixed; /* tetap di atas, menempel dengan tombol close */
    top: 13px;
    right: 60px; /* sesuaikan posisi dengan tombol Close */
    display: flex;
    gap: 8px;
    z-index: 999999;
}
...
.gl-extra-buttons button {
    ...
    border: none;
    color: #fff;
    padding: 8px 10px; /* proporsional kotak */
    width: 38px;  /* ukuran kotak */
    height: 38px; /* ukuran kotak */
    border-radius: 6px; /* kotak dengan sudut agak membulat */
    font-size: 16px;
    cursor: pointer;
    display: flex;
    align-items: center;
