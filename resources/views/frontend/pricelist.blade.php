    ...
    <section class="bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 py-16">
        <div class="max-w-7xl mx-auto px-4" x-data="serviceSlider()">
            ...
            <div class="text-center mb-6 overflow-visible relative px-4">
                ...
                <p class="mt-3 text-center text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed scroll-fade">
                    Pilih paket foto terbaik dengan harga transparan, fleksibel, dan kualitas profesional untuk setiap momen
                    spesial Anda.
                </p>
                <div
            ...
            <div class="relative mb-12">
                <div class="flex gap-3 px-2 py-2 overflow-x-auto scrollbar-hide justify-start sm:justify-center">
                    <button @click="selectCategory('all')"
                        :class="selected === 'all' ?
                            'bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-lg scale-105' :
                            'bg-white/80 dark:bg-gray-800 text-gray-700 dark:text-gray-200 ring-1 ring-gray-200 dark:ring-gray-700 hover:bg-blue-50 dark:hover:bg-gray-700'"
                        class="inline-flex items-center justify-center flex-shrink-0 whitespace-nowrap px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300">
                        Semua
                    </button>
                                    ...
                                    <div x-show="open" x-collapse class="mt-0 px-6 pb-6 space-y-8">
                                        ...
                                        @if ($service->backgrounds->count())
                                            <div class="pt-6 border-t border-indigo-200 dark:border-indigo-700">
                                                <h4 class="text-center font-semibold mb-4 text-gray-900 dark:text-gray-100">
