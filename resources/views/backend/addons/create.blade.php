                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="unit" id="unit"
                                    ...
                                    <option value="person"
                                        {{ old('unit', $data->unit ?? '') == 'person' ? 'selected' : '' }}>
                                        Orang
                                    </option>

                                    <option value="minute"
                                        {{ old('unit', $data->unit ?? '') == 'minute' ? 'selected' : '' }}>
                                        Menit
                                    </option>

                                    <option value="item"
                                        {{ old('unit', $data->unit ?? '') == 'item' ? 'selected' : '' }}>
                                        Item
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="max_qty" id="max_qty"
                                    ...
                                    placeholder="Masukkan jumlah maksimal" value="{{ old('max_qty') }}">
                                @error('max_qty')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="card-body pb-0">
                                <div class="form-group">
                                    ...
                                    <select name="is_active" id="is_active" class="form-select" required>
                                        ...
                                        <option value="1"
                                            {{ old('is_active', $addon->is_active ?? 1) == 1 ? 'selected' : '' }}>
                                            Aktif
                                        </option>

                                        <option value="0"
                                            {{ old('is_active', $addon->is_active ?? 1) == 0 ? 'selected' : '' }}>
                                            Nonaktif
                                        </option>
...
@section('js')
    <script>
        ...
        $('#name').on("change keyup paste click", function() {
            var Text = $(this).val().trim().toLowerCase().replace(/[^a-z0-9]+/g, '-');
            $('#slug').val(Text);
        });
