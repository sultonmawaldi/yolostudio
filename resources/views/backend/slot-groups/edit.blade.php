...
@section('content')
    ...
    <div class="container-fluid">
        <div class="justify-content-between pb-5">
            ...
            <form role="form" method="post" action="{{ route('slot-group.update', $slotGroup->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="card-body">
                                    ...
                                    <select name="employee_id"
                                        ...
                                        @foreach ($employees as $employee)
                                            <option value="{{ $employee->id }}"
                                                {{ old('employee_id', $slotGroup->employee_id) == $employee->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="slot_duration"
                                        ...
                                        value="{{ old('slot_duration', $slotGroup->slot_duration) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="break_duration"
                                        ...
                                        value="{{ old('break_duration', $slotGroup->break_duration) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" name="start_time"
                                        ...
                                        value="{{ old('start_time', $slotGroup->start_time) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" name="end_time"
                                        ...
                                        value="{{ old('end_time', $slotGroup->end_time) }}">
                        ...
                        {{-- ================= JAM KERJA ================= --}}
                        @php
                            // 🔥 FIX ERROR JSON decode (INI PENTING)
                            $working = old('working_hours', $slotGroup->working_hours);
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($days as $key => $label)
                                    <div class="border rounded p-3 mb-3">
                                        ...
                                        {{-- LABEL --}}
                                        <div class="row mb-1">
                                            <div class="col-md-5"><small>Mulai</small></div>
                                            <div class="col-md-5"><small>Selesai</small></div>
                                        ...
                                        <div id="container-{{ $key }}">
                                            ...
                                            @if (!empty($working[$key]))
                                                @foreach ($working[$key] as $i => $time)
                                                    <div class="row mb-2 time-row align-items-center">

                                                        <div class="col-md-5">
                                                            <input type="time"
                                                                name="working_hours[{{ $key }}][{{ $i }}][start]"
                                                                class="form-control" value="{{ $time['start'] ?? '' }}">
                                                        </div>

                                                        <div class="col-md-5">
                                                            <input type="time"
                                                                name="working_hours[{{ $key }}][{{ $i }}][end]"
                                                                class="form-control" value="{{ $time['end'] ?? '' }}">
                                                        </div>
...
@section('js')
    ...
    <script>
        function addRow(day) {
            ...
            row.innerHTML = `
        <div class="col-md-5">
            <input type="time" name="working_hours[${day}][${index}][start]" class="form-control">
        </div>

        <div class="col-md-5">
            <input type="time" name="working_hours[${day}][${index}][end]" class="form-control">
        </div>
